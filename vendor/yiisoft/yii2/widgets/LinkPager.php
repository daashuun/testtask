...
class LinkPager extends Widget
{
     ...
     */
    public $options = ['class' => 'dor-pagination mb128'];
    /**
    ...
    protected function renderPageButtons()
    {
        ...
        $buttons = [];
        $currentPage = (!strlen($this->currentPage)>0) ? $this->pagination->getPage() : $this->currentPage;
        ...
        for ($i = $beginPage; $i <= $endPage; ++$i) {
            ...
            // first page
            $firstPageLabel = (($currentPage != 0)&&($currentPage != 1)) ? '1' : false;
            if (($firstPageLabel !== false)&&($i === $beginPage)) {
                $buttons[] = $this->renderPageButton($firstPageLabel, 0, $this->firstPageCssClass, $currentPage <= 0, false);
                if ($currentPage != 2)
                    $buttons[] = $this->renderPageButton('...', $currentPage-2, "grey", 0, 0);
            }
            ...
            // last page
            $lastPageLabel = (($currentPage != $pageCount-2)&&($currentPage != $pageCount-1)) ? $pageCount : false;
            if (($lastPageLabel !== false)&&($i === $endPage)) {
